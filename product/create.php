...
<form action="http://localhost/glu-base-api-feature-opdracht3-uitleg/product/create.php" method="post">
    ...
    <input type="number" name="category_id" id="category_id" placeholder="category_id">
